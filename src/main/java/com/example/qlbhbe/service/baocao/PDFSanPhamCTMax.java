...
public class PDFSanPhamCTMax {
    ...
    public Map<String, String> exportChiPhiPDF(SanPhamDTO sanPhamDTO) throws Exception {
        try {
            Document document = new Document();
            String FILE = "D:/BaoCaoNhapKho" + System.currentTimeMillis() + ".pdf";
...
//    }
    ...
    private void addTitlePage(Document document, SanPhamDTO sanPhamDTO)
        ...
        addEmptyLine(preface, 1);
        setRow(preface, "BÁO CÁO HÀNG NHẬP KHO", font(18, Font.BOLD), Element.ALIGN_CENTER);
    ...
    private void createTable(Paragraph paragraph, SanPhamDTO sanPhamDTO)
        ...
        setHeaderTable(table, "Số Lượng Nhập", Element.ALIGN_CENTER, c1);
        ...
        List<SanPhamDTO> sanPhamDTOList = sanPhamReport.getSanPhamChiPhiMax(sanPhamDTO);
        for (SanPhamDTO sanPhamDTO1 : sanPhamDTOList) {
            ...
            setContentTable(table, String.valueOf(sanPhamDTO1.getSoLuongNhap().intValue()), Element.ALIGN_CENTER, c1);
            setContentTable(table, String.valueOf(sanPhamDTO1.getGiaNhap().intValue()), Element.ALIGN_CENTER, c1);
            setContentTable(table, String.valueOf(sanPhamDTO1.getTotalChiPhi().intValue()), Element.ALIGN_CENTER, c1);
